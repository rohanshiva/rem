  ...
  return (
    <div
      style={{
        ...
        width: `${size}px`,
        borderRadius: "50%",
        // Updated to match your button gradient
        background: "linear-gradient(135deg, #4fc3f7 0%, #29b6f6 50%, #42a5f5 100%)",
        // Updated shadow to match your card shadow style
        boxShadow: `inset -1px 1px 10px rgba(255, 255, 255, 0.5), rgba(79, 195, 247, 0.3) 0px ${s(5)}px ${s(
          10
    ...
    >
      <div
        style={{
          ...
          width: "100%",
          backgroundImage:
            "radial-gradient(circle at 50% 90%,rgb(226, 255, 255) 0%,rgba(79, 195, 247, 0) 70%)",
        }}
      />
      <motion.div
        animate={{
        ...
        style={{
          ...
          background:
            "radial-gradient(circle at 33% 12%, #F0FFFF 0%, #4fc3f7 26%, rgba(79,195,247,0.00) 63%)",
          filter: `blur(${s(2)}px)`,
        }}
      />
      <div
        style={{
          ...
          borderRadius: "50%",
          backgroundImage:
            "radial-gradient(circle at 31% 12%, rgba(254,254,254,0.0) 0%, rgba(79,195,247,0.0) 31%, #29b6f6 77%)",
          filter: `blur(${s(1)}px)`,
          opacity: 0.65,
        }}
      />
      <motion.div
        ...
        style={{
          ...
          width: `${s(48)}px`,
          background:
            "linear-gradient(-36deg, #E8FAFF 12%, #4fc3f7 36%, rgba(79,195,247,0.00) 54%)",
        }}
      />
      <motion.div
        animate={{
        ...
        style={{
          ...
          backgroundImage:
            "linear-gradient(163deg, #E8FAFF 0%, #42a5f5 19%, rgba(66,165,245,0.00) 50%)",
        }}
      />
      <motion.div
        animate={{
      ...
      <div
        style={{
          ...
          backgroundImage:
            "linear-gradient(rgb(79, 195, 247) 0%,rgba(255, 255, 255, 0) 100%)",
          borderRadius: `${s(10)}px`,
          filter: `blur(${s(4)}px)`,
        }}
      />
      <div
        style={{
          ...
          backgroundImage:
            "linear-gradient(rgb(66, 165, 245) 0%, rgba(255, 255, 255, 0) 100%)",
          borderRadius: `${s(10)}px`,
          filter: `blur(${s(4)}px)`,
        }}
      />
